...
categoryProtectedRouter.post("/:username", authorize([Resource.CATEGORY], [Action.CREATE]), createCategoryValidation, createCategories);
...
categoryProtectedRouter.get("/:username/:categorySlug", authorize([Resource.CATEGORY], [Action.READ]), attachTargetCategory, categoryDetails);
...
categoryProtectedRouter.put("/:username/:categorySlug", authorize([Resource.CATEGORY], [Action.UPDATE]), attachTargetCategory, updateCategory);
