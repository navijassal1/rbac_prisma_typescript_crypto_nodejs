 ...
 */
export type ExpressMiddlewareParams = (req: Request, res: Response, next: NextFunction) => Promise<any> | any;
/**
 ...
 */
export type ErrorHandlerParams = (err: any, req: Request, res: Response, next: NextFunction) => Promise<any> | any;
/**
 ...
 */
export type ResponseParams = (res: Response, status: number, success: boolean, message: string, data?: object) => any;
/**
 ...
 * @param res - Express response object
 */
export type unauthorizedResponseParams = (res: Response) => any;
