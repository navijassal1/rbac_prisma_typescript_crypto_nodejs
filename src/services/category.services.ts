 ...
 */
export const listCategoriesService = async (targetUser: TargetParams): Promise<serviceResponse> => {
    try {
 ...
 * @returns {Promise<serviceResponse>} - Success status and message
 */
export const deleteCategoryService = async (targetCategory: TargetParams): Promise<serviceResponse> => {
    try {
        const success = await prisma.category.update({
            where: { id: targetCategory.id },
            data: {
