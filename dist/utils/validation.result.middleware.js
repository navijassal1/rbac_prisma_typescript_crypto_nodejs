...
export const validateResult = (req, res, next) => {
    ...
    if (!errors.isEmpty()) {
        ...
        let message = 'Invalid entries'; // generic error message
        let defaultStatus = STATUS.BAD_REQUEST; // default HTTP status
        ...
        if (typeof firstError.msg === 'object' && firstError.msg !== null && 'code' in firstError.msg) {
            const errorCode = firstError.msg.code;
            switch (errorCode) {
                case 400:
...
//# sourceMappingURL=validation.result.middleware.js.map