 ...
 */
export declare const listCategoriesService: (targetUserId: TargetParams) => Promise<serviceResponse>;
/**
 ...
 */
export declare const createCategoriesService: (targetUserId: TargetParams, categoryName: CategoryNameParams) => Promise<serviceResponse>;
/**
 ...
 * @returns {Promise<serviceResponse>} - Success status and message
 */
export declare const updateCategoryService: (targetCategoryId: TargetParams, categoryName: CategoryNameParams) => Promise<serviceResponse>;
/**
 ...
 * @returns {Promise<serviceResponse>} - Success status and message
 */
export declare const deleteCategoryService: (targetCategoryId: TargetParams) => Promise<serviceResponse>;
