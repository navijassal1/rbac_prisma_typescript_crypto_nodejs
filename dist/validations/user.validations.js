...
export const signupValidation = [
    ...
    body('role')
        ...
        if (!roleExists)
            throw ({ code: STATUS.NOT_FOUND, message: 'Invalid Role' });
        return true;
    }),
...
export const ChangePasswordValidation = [
    ...
    body('confirm_new_password')
        ...
        if (!username)
            throw ({ code: STATUS.UNPROCESSIBLE, message: 'Invalid Request' });
        ...
        if (!oldPasswordCorrect)
            throw ({ code: STATUS.BAD_REQUEST, message: 'Invalid Old Credentials' });
