...
userPublicRouter.post("/signup", signupValidation, signUp);
// User login route
// 1. loginValidation → validates request body
// 2. validateResult → checks validation errors
// 3. login → handles authentication logic
userPublicRouter.post("/login", loginValidation, login);
// Refresh token route
...
userPublicRouter.get("/refresh-token", refreshTokenValidation, refreshAccessToken);
