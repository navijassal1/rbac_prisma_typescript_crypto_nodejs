...
export type ExpressMiddlewareParams = (req: Request, res: Response, next: NextFunction) => Promise<ApiResponseReturn | NextFunctionReturn>;
/**
 ...
 */
export type ErrorHandlerParams = (err: Error, res: Response) => object;
/**
 ...
 */
export type ResponseParams = (res: Response, status: number, success: boolean, message: string, data?: object) => object;
/**
 ...
 * @param res - Express response object
 */
export type unauthorizedResponseParams = (res: Response) => object;
